...
IF %ERRORLEVEL% NEQ 0 (
    ECHO ⚠️ Тесты в Edge завершились с ошибками или падениями. Продолжаем генерацию отчета.
) ELSE (
    ECHO ✅ Все тесты в Edge успешно завершены.
)
ECHO.
