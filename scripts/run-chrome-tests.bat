...
IF %ERRORLEVEL% NEQ 0 (
    ECHO ⚠️ Тесты в Chrome завершились с ошибками или падениями. Продолжаем генерацию отчета.
) ELSE (
    ECHO ✅ Все тесты в Chrome успешно завершены.
)
ECHO.
